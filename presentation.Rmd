...
- The visualisation shows a strong imbalance in bird count across habitat, with forest having over 40,000 individuals

- Shrubland and woodland have moderate counts, but the rest have fewer than 4,000 individuals

- Suggests some samples may not be fully representative of their population

]

---
#How Trophic Level affects Culmen Length in each Habitat
...
--
.pull-left[
- Illustrate the distribution of culmen lengths across various trophic levels within each habitat
...
.pull-right[
- We calculated that three quarters of the birds have culmen lengths between the values of 8 and 25, with the peak occurring around 15mm

- As beak length increases past 25 mm the number of individuals greatly decreases
