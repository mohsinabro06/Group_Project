...
.pull-right[
- This shows that the majority of culmen lengths lie between 8 and 25 mm.
...
```
.pull-right[
- We created a logistic model which predicts the beak length of a bird based on habitat, mass and trophic level

- The median of culmen lengths is 19.6 mm so we decided to split beak lengths into big and small by the bound 20 mm
...
```{r castle, echo = FALSE, out.width = "55%", fig.align = "center"}
include_graphics("img/bird2.jpg")
```
