...
style_xaringan(text_bold_color =  "red")
```
...
#Background image
style_xaringan(
  title_slide_background_image = "img/parrot.jpg"
  )
```

class: center, middle

## Investigating how trophic level affects the physical characteristics of birds within each habitat

---
# What choices we made and why

- We decided to focus on how the eating habits of the birds (characterized by their trophic level), affects their physical characteristics because we wanted to investigate how the type of food each bird consumes will affect their appearance.

- We also decided to separate the birds by habitat, because the food available will differ by each habitat, and consequently so will the eating habits (trophic level) of the birds. 
---
# What variables are we investigating?
- Habitat, Trophic Level, Culmen Length and Mass

- Culmen length of a bird

```{r culmen, echo = FALSE, out.width = "40%", fig.align = "Centre"}
