...
The second bar chart displays the total number of individuals within each trophic level. Similarly, there is also a strong imbalance amongst trophic levels, as carnivores appear to have nearly 50,000 individuals, significantly more birds than scavenger birds. 
...
```{r echo=FALSE}
sensitivity_1 <- 439/(439+33)
specificity_1 <- 285/(285+137)

ss_df <- data.frame(sensitivity = c(sensitivity_1),
                    specificity = c(specificity_1))
ss_df
```
