...
AVONET3_BirdTree <- read_excel("data/AVONET3_BirdTree.xlsx", 
    sheet = "AVONET3_BirdTree")
>>>>>>> 4d14d346da2e75ad875a655e95b20183c7f9d03d
...
Investigating the relationship between beak length and trophic level within each habitat.
...
The dataset includes data about 9,993 different bird species, the key variables within the dataset we are investigating are; Beak Length (Culmen), Habitat, Trophic Level and Mass.
